  ...
  async up (queryInterface, Sequelize) {
    ...
    */
    return queryInterface.bulkInsert("Messages", [
      ...
      {message: "Basketball fans, what do you think of Lebron's performance this season?", sender_id: 9, channel_id: 5},
      {message: "Player discussions: Who is your favorite player and why?", sender_id: 10, channel_id: 5},
