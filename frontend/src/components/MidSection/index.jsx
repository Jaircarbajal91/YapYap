    ...
    isLoaded && (
      <>
        ...
        <div className={`md:hidden fixed left-0 top-0 bottom-0 z-50 w-[85vw] max-w-[19rem] bg-surfaceLight/95 transform transition-transform duration-300 ease-in-out shadow-2xl flex flex-col ${
          ...
          <div className="flex-1 min-h-0 overflow-y-auto scrollbar overflow-x-visible px-4 py-4" style={{ paddingBottom: '80px' }}>
            {serverClicked ? (
              <Channels />
            ) : (
              <DirectMessagesList
          ...
          <div className="absolute bottom-0 left-0 right-0 flex items-center justify-between gap-2 border-t border-borderMuted/60 bg-surface/95 px-3 py-2.5 shadow-inner-card sm:gap-3 sm:px-4 sm:py-3">
