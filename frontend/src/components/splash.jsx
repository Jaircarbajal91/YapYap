    ...
    return (
        <div className="top_section h-screen">
            <div className="flex flex-row justify-evenly relative items-end w-full h-4/6 bg-hero gap-x-2 bg-splash-1 bg-bottom bg-no-repeat">
                <Navbar />
                <img className="absolute max-w-2xl -left-20 -ml-20 z-10 w-2/5" src="../../assets/images/splash2.svg" alt="" />
                ...
                <img className="absolute max-w-2xl -right-8 z-10 w-2/5" src="../../assets/images/splash3.svg" alt="" />
            </div>
